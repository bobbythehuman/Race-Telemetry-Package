...
class PacketHeader(DataTypes.STRUCTURE.value):
    ...
    _fields_ = [
        ("m_packetFormat",              DataTypes.UNSIGNED_INT16.value),    # 2025
...
class PacketLapPositionsData(DataTypes.STRUCTURE.value):
    ...
    _fields_ = [
        ...
        ("m_positionForVehicleIdx",     DataTypes.UNSIGNED_INT8.value * 50 * 22),   # Array holding the position of the car in a given lap, 0 if no record
    ]
