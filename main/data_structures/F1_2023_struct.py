...
class PacketHeader(DataTypes.STRUCTURE):
    ...
    _fields_ = [
        ("m_packetFormat",              DataTypes.UNSIGNED_INT16),    # 2023
        ("m_gameYear",                  DataTypes.UNSIGNED_INT8),     # Game year - last two digits e.g. 23
...
class PacketMotionExData(DataTypes.STRUCTURE):
    ...
    _fields_ = [
        ...
        ("m_angularVelocityX",          DataTypes.FLOAT),         # Angular velocity x-component – radians/s
        ...
        ("m_angularAccelerationX",      DataTypes.FLOAT),         # Angular acceleration x-component – radians/s
